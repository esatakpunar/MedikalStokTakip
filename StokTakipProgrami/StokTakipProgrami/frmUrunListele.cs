...
namespace StokTakipProgrami
{
    public partial class frmUrunListele : Form
    {
        ...
        {
            Barkodtxt.Text = dataGridView1.CurrentRow.Cells["barkod"].Value.ToString();
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("update urun set urunadi=@urunadi, miktari=@miktari, alisfiyati=@alisfiyati, satisfiyati=@satisfiyati where barkod=@barkod",baglanti);
        ...
        private void btnMarkaGuncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("update urun set kategori=@kategori, marka=@marka where barkod=@barkod" , baglanti);
                komut.Parameters.AddWithValue("@barkod", Barkodtxt.Text);
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("delete from urun where barkod='" + dataGridView1.CurrentRow.Cells["barkod"].Value.ToString() + "'", baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
            daset.Tables["urun"].Clear();
            UrunListele();
        ...
        private void txtBarkodAra_TextChanged(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("select *from urun where barkod like '%" + txtBarkodAra.Text + "%'", baglanti);
            adtr.Fill(tablo);
        ...
        {
            frmUrunRaporla raporla = new frmUrunRaporla();
            raporla.ShowDialog();
        }

        private void button2_Click(object sender, EventArgs e)
        {
            frmUrunGrafik grafik = new frmUrunGrafik();
            grafik.ShowDialog();
        }
    }
}
